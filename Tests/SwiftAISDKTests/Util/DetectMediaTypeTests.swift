...
struct DetectMediaTypeTests {
    ...
    func testDetectGIFFromBytes() throws {
    ...
    func testDetectGIFFromBase64() throws {
    ...
    func testDetectPNGFromBytes() throws {
    ...
    func testDetectPNGFromBase64() throws {
    ...
    func testDetectJPEGFromBytes() throws {
    ...
    func testDetectJPEGFromBase64() throws {
    ...
    func testDetectWebPFromBytes() throws {
    ...
    func testDetectWebPFromBase64() throws {
    ...
    func testNotDetectRIFFAudioAsWebPFromBytes() throws {
    ...
    func testNotDetectRIFFAudioAsWebPFromBase64() throws {
    ...
    func testDetectBMPFromBytes() throws {
    ...
    func testDetectBMPFromBase64() throws {
        let bmpBytes = Data([0x42, 0x4D, 0xFF, 0xFF])
    ...
    func testDetectTIFFLEFromBytes() throws {
    ...
    func testDetectTIFFLEFromBase64() throws {
    ...
    func testDetectTIFFBEFromBytes() throws {
    ...
    func testDetectTIFFBEFromBase64() throws {
    ...
    func testDetectAVIFFromBytes() throws {
        let avifBytes = Data([
    ...
    func testDetectAVIFFromBase64() throws {
    ...
    func testDetectHEICFromBytes() throws {
        let heicBytes = Data([
    ...
    func testDetectHEICFromBase64() throws {
    ...
    func testDetectMP3FromBytes() throws {
    ...
    func testDetectMP3FromBase64() throws {
    ...
    func testDetectMP3WithID3FromBytes() throws {
    ...
    func testDetectMP3WithID3FromBase64() throws {
        let mp3WithID3Bytes = Data([
            0x49, 0x44, 0x33,  // 'ID3'
            0x03, 0x00,        // version
            0x00,              // flags
    ...
    func testDetectWAVFromBytes() throws {
        let wavBytes = Data([
            0x52, 0x49, 0x46, 0x46,  // "RIFF"
            0x24, 0x00, 0x00, 0x00,  // file size (example: 36 bytes)
            0x57, 0x41, 0x56, 0x45,  // "WAVE" (not "WEBP")
    ...
    func testDetectWAVFromBase64() throws {
        let wavBytes = Data([
            0x52, 0x49, 0x46, 0x46,  // "RIFF"
            0x24, 0x00, 0x00, 0x00,  // file size (example: 36 bytes)
            0x57, 0x41, 0x56, 0x45,  // "WAVE" (not "WEBP")
    ...
    func testNotDetectWebPAsWAVFromBytes() throws {
        let webpBytes = Data([
            0x52, 0x49, 0x46, 0x46,  // "RIFF"
            0x24, 0x00, 0x00, 0x00,  // file size (example: 36 bytes)
            0x57, 0x45, 0x42, 0x50,  // "WEBP"
    ...
    func testNotDetectWebPAsWAVFromBase64() throws {
        let webpBytes = Data([
            0x52, 0x49, 0x46, 0x46,  // "RIFF"
            0x24, 0x00, 0x00, 0x00,  // file size (example: 36 bytes)
            0x57, 0x45, 0x42, 0x50,  // "WEBP"
    ...
    func testDetectOGGFromBytes() throws {
    ...
    func testDetectOGGFromBase64() throws {
    ...
    func testDetectFLACFromBytes() throws {
    ...
    func testDetectFLACFromBase64() throws {
    ...
    func testDetectAACFromBytes() throws {
    ...
    func testDetectAACFromBase64() throws {
        let aacBytes = Data([0x40, 0x15, 0x00, 0x00])
    ...
    func testDetectMP4FromBytes() throws {
    ...
    func testDetectMP4FromBase64() throws {
    ...
    func testDetectWEBMFromBytes() throws {
    ...
    func testDetectWEBMFromBase64() throws {
    ...
    func testUnknownImageFormat() throws {
    ...
    func testUnknownAudioFormat() throws {
        let unknownBytes = Data([0x00, 0x01, 0x02, 0x03])
    ...
    func testEmptyBytesImage() throws {
        let emptyBytes = Data([])
    ...
    func testEmptyBytesAudio() throws {
        let emptyBytes = Data([])
    ...
    func testShortBytesImage() throws {
    ...
    func testShortBytesAudio() throws {
    ...
    func testInvalidBase64Image() throws {
    ...
    func testInvalidBase64Audio() throws {
        let invalidBase64 = "invalid123"
