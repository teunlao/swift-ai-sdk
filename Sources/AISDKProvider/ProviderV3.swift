...
public protocol ProviderV3: Sendable {
     ...
     */
    func languageModel(modelId: String) -> any LanguageModelV3
    ...
    /**
     ...
     - Throws: `NoSuchModelError` if no such model exists.
     */
    func textEmbeddingModel(modelId: String) -> any EmbeddingModelV3<String>
    ...
    /**
     ...
     - Throws: `NoSuchModelError` if no such model exists.
     */
    func imageModel(modelId: String) -> any ImageModelV3
     ...
     */
    func transcriptionModel(modelId: String) -> (any TranscriptionModelV3)?
     ...
     */
    func speechModel(modelId: String) -> (any SpeechModelV3)?
}
