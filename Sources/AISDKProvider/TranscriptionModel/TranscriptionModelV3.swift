...
/**
 ...
 Port of `@ai-sdk/provider/src/transcription-model/v3/transcription-model-v3.ts`.
 ...
 */
public protocol TranscriptionModelV3: Sendable {
...
extension TranscriptionModelV3 {
    public var specificationVersion: String { "v3" }
}

/// Result from a transcription call
public struct TranscriptionModelV3Result: Sendable {
