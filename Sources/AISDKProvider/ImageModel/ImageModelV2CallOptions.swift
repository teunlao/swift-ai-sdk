/**
 Options for ImageModelV2 doGenerate call.

 Port of `@ai-sdk/provider/src/image-model/v2/image-model-v2-call-options.ts`.
 */
public struct ImageModelV2CallOptions: Sendable {
