...
final class OpenAILanguageModelV4Adapter: LanguageModelV4, @unchecked Sendable {
...
private func convertLanguageModelV4CallOptionsToV3(_ options: LanguageModelV4CallOptions) throws -> LanguageModelV3CallOptions {
    if options.reasoning != nil {
        throw UnsupportedFunctionalityError(functionality: "language model v4 reasoning option on v3-backed OpenAI model")
    }
...
private func convertLanguageModelV4MessagePartToV3(_ value: LanguageModelV4MessagePart) throws -> LanguageModelV3MessagePart {
    ...
    case .custom:
        throw UnsupportedFunctionalityError(functionality: "language model v4 custom prompt parts on v3-backed OpenAI model")
    case .reasoningFile:
        throw UnsupportedFunctionalityError(functionality: "language model v4 reasoning-file prompt parts on v3-backed OpenAI model")
    }
}
...
private func convertLanguageModelV4ToolResultContentPartToV3(
    ...
    case let .text(text, providerOptions):
        if providerOptions != nil {
            throw UnsupportedFunctionalityError(functionality: "tool result text providerOptions on v3-backed OpenAI model")
        }
        return .text(text: text)
    case let .file(data, mediaType, _, providerOptions):
        if providerOptions != nil {
            throw UnsupportedFunctionalityError(functionality: "tool result file providerOptions on v3-backed OpenAI model")
        }
        return .media(data: try convertSharedV4FileDataToBase64String(data), mediaType: mediaType)
    case .custom:
        throw UnsupportedFunctionalityError(functionality: "tool result custom content on v3-backed OpenAI model")
    }
}
...
private func convertSharedV4FileDataToLanguageModelV3DataContent(_ value: SharedV4FileData) throws -> LanguageModelV3DataContent {
    ...
    case .reference:
        throw UnsupportedFunctionalityError(functionality: "provider reference file data on v3-backed OpenAI model")
    }
}
...
private func convertSharedV4FileDataToBase64String(_ value: SharedV4FileData) throws -> String {
    ...
    case .url:
        throw UnsupportedFunctionalityError(functionality: "tool result file URLs on v3-backed OpenAI model")
    case .reference:
        throw UnsupportedFunctionalityError(functionality: "provider reference file data on v3-backed OpenAI model")
    }
}

func convertLanguageModelV3GenerateResultToV4(_ result: LanguageModelV3GenerateResult) throws -> LanguageModelV4GenerateResult {
...
func convertLanguageModelV3StreamPartToV4(_ value: LanguageModelV3StreamPart) throws -> LanguageModelV4StreamPart {
    switch value {
