/**
 Mock implementation of LanguageModelV2 for testing.

 Port of `@ai-sdk/ai/src/test/mock-language-model-v2.ts`.
...
/// Mock implementation of LanguageModelV2 protocol for testing purposes.
///
...
public final class MockLanguageModelV2: LanguageModelV2, @unchecked Sendable {
    public let specificationVersion: String = "v2"
    public let provider: String
    public let modelId: String

    /// Recorded calls to doGenerate
    public private(set) var doGenerateCalls: [LanguageModelV2CallOptions] = []

    /// Recorded calls to doStream
    public private(set) var doStreamCalls: [LanguageModelV2CallOptions] = []
    ...
    private enum GenerateBehavior {
        case function((LanguageModelV2CallOptions) async throws -> LanguageModelV2GenerateResult)
        case singleValue(LanguageModelV2GenerateResult)
        case array([LanguageModelV2GenerateResult])
    }

    /// Behavior type for doStream
    private enum StreamBehavior {
        case function((LanguageModelV2CallOptions) async throws -> LanguageModelV2StreamResult)
        case singleValue(LanguageModelV2StreamResult)
        case array([LanguageModelV2StreamResult])
    }
    ...
    public func doStream(options: LanguageModelV2CallOptions) async throws -> LanguageModelV2StreamResult {
