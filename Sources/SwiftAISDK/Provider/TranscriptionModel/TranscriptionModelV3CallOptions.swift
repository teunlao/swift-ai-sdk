...
/**
 ...
 Port of `@ai-sdk/provider/src/transcription-model/v3/transcription-model-v3-call-options.ts`.
 */
public struct TranscriptionModelV3CallOptions: Sendable {
    /// Audio data to transcribe.
    /// Accepts `Data` (binary) or `String` (base64 encoded audio file).
    public let audio: TranscriptionModelV3Audio
    ...
    public init(
        audio: TranscriptionModelV3Audio,
        mediaType: String,
...
public enum TranscriptionModelV3Audio: Sendable, Equatable {
    /// Binary audio data
    case binary(Data)
