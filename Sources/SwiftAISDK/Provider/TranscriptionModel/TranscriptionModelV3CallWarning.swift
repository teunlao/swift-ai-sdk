/**
 ...
 Port of `@ai-sdk/provider/src/transcription-model/v3/transcription-model-v3-call-warning.ts`.

 The call will proceed, but some settings might not be supported, which can lead to
 suboptimal results.
 */
public enum TranscriptionModelV3CallWarning: Sendable, Equatable {
