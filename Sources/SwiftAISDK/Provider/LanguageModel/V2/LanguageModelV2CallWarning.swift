...
public enum LanguageModelV2CallWarning: Sendable, Equatable, Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "unsupported-tool":
            let tool = try container.decode(LanguageModelV2Tool.self, forKey: .tool)
            let details = try container.decodeIfPresent(String.self, forKey: .details)
...
public enum LanguageModelV2Tool: Sendable, Equatable, Codable {
    case function(LanguageModelV2FunctionTool)
    case providerDefined(LanguageModelV2ProviderDefinedTool)
    ...
    public init(from decoder: Decoder) throws {
        ...
        switch type {
        case "function":
            self = .function(try LanguageModelV2FunctionTool(from: decoder))
        case "provider-defined":
            self = .providerDefined(try LanguageModelV2ProviderDefinedTool(from: decoder))
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .type,
                in: container,
