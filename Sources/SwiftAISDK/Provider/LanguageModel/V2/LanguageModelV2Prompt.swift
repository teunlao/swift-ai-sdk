...
/**
 ...
 export type LanguageModelV2Message =
   | { role: 'system'; content: string; providerOptions?: SharedV2ProviderOptions }
   | { role: 'user'; content: Array<...>; providerOptions?: SharedV2ProviderOptions }
   | { role: 'assistant'; content: Array<...>; providerOptions?: SharedV2ProviderOptions }
   | { role: 'tool'; content: Array<...>; providerOptions?: SharedV2ProviderOptions };
 ```
 */
public enum LanguageModelV2Message: Sendable, Equatable, Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let providerOptions = try container.decodeIfPresent(SharedV2ProviderOptions.self, forKey: .providerOptions)
        ...
        case "tool":
            let content = try container.decode([LanguageModelV2ToolResultPart].self, forKey: .content)
...
public enum LanguageModelV2MessagePart: Sendable, Equatable, Codable {
    ...
    case reasoning(LanguageModelV2ReasoningPart)
    case toolCall(LanguageModelV2ToolCallPart)
    case toolResult(LanguageModelV2ToolResultPart)
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "reasoning":
            self = .reasoning(try LanguageModelV2ReasoningPart(from: decoder))
        case "tool-call":
            self = .toolCall(try LanguageModelV2ToolCallPart(from: decoder))
        case "tool-result":
            self = .toolResult(try LanguageModelV2ToolResultPart(from: decoder))
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .type,
                in: container,
...
public struct LanguageModelV2TextPart: Sendable, Equatable, Codable {
    public let type: String = "text"
    public let text: String
    public let providerOptions: SharedV2ProviderOptions?

    public init(text: String, providerOptions: SharedV2ProviderOptions? = nil) {
        self.text = text
...
public struct LanguageModelV2ReasoningPart: Sendable, Equatable, Codable {
...
public struct LanguageModelV2FilePart: Sendable, Equatable, Codable {
    public let type: String = "file"
    public let filename: String?
    public let data: LanguageModelV2DataContent
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try container.decode(LanguageModelV2DataContent.self, forKey: .data)
...
public struct LanguageModelV2ToolCallPart: Sendable, Equatable, Codable {
...
public struct LanguageModelV2ToolResultPart: Sendable, Equatable, Codable {
    public let type: String = "tool-result"
    public let toolCallId: String
    public let toolName: String
    public let output: LanguageModelV2ToolResultOutput
    public let providerOptions: SharedV2ProviderOptions?
    ...
    public init(from decoder: Decoder) throws {
        ...
        toolCallId = try container.decode(String.self, forKey: .toolCallId)
        toolName = try container.decode(String.self, forKey: .toolName)
        output = try container.decode(LanguageModelV2ToolResultOutput.self, forKey: .output)
        providerOptions = try container.decodeIfPresent(SharedV2ProviderOptions.self, forKey: .providerOptions)
    }
...
public enum LanguageModelV2ToolResultOutput: Sendable, Equatable, Codable {
    case text(value: String)
    case json(value: JSONValue)
    case errorText(value: String)
    case errorJson(value: JSONValue)
    case content(value: [LanguageModelV2ToolResultContentPart])
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "content":
            let value = try container.decode([LanguageModelV2ToolResultContentPart].self, forKey: .value)
...
public enum LanguageModelV2ToolResultContentPart: Sendable, Equatable, Codable {
