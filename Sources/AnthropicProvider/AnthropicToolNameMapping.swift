...
/// Maps between custom tool names (client) and provider tool names (Anthropic).
///
/// Port of `@ai-sdk/provider-utils/src/create-tool-name-mapping.ts`.
struct AnthropicToolNameMapping: Sendable {
    ...
    static func create(
        ...
        return AnthropicToolNameMapping(
