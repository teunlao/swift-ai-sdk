...
- Upstream package: `external/vercel-ai-sdk/packages/voyage/src/**`
...
- [ ] Upstream provider package exists, but Swift has no `VoyageProvider` target.
...
- This file is an intake tracker only. It does not mark Voyage parity as
