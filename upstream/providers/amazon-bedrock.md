...
- Audited against upstream commit: `b0c59e850b3d51db40a0816c562da52c63ceaba2`
...
- [x] Chat prompt reasoning parity: assistant reasoning now survives prompt conversion even without Bedrock metadata, and reasoning text is no longer trimmed when a Bedrock signature is present (matching upstream `convert-to-bedrock-chat-messages` behavior).
