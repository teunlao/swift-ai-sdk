...
- Upstream package: `external/vercel-ai-sdk/packages/anthropic-aws/src/**`
...
- [ ] Upstream provider package exists, but Swift has no `AnthropicAWSProvider` target.
...
- This file is an intake tracker only. It does not mark Anthropic AWS parity as
