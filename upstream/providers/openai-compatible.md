...
- [ ] P0 tracking page was missing before the 2026-06-30 upstream intake.
- [ ] Re-audit against upstream `85a80fc6e71558717899e30c9f1fc0e9eb7d733d`.

## Notes

- This file is an intake tracker only. It does not mark OpenAI-compatible
  parity as verified against the current baseline.
