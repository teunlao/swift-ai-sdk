...
let result = try await generateText(
  model: openai("gpt-4o"),
  tools: ["weather": weather.eraseToTool()],
...
let _ = try await generateText(model: openai("gpt-4o"), tools: ["myTool": myTool], prompt: "...")
```
...
let result = try await generateText(model: openai("gpt-4o"), tools: ["computer": computer], prompt: "...")
```
