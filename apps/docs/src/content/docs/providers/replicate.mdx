---
title: Replicate
description: Learn how to use Replicate models with the Swift AI SDK.
---

_This page adapts the original AI SDK documentation: Replicate (https://github.com/vercel/ai/blob/main/content/providers/01-ai-sdk-providers/60-replicate.mdx)._ 
...
> Note: Model support for `size` and other parameters varies by model. Check the
> model's documentation on Replicate for supported options and additional
> parameters that can be passed via `providerOptions.replicate`.
