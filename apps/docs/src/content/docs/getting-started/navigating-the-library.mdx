...
- **Provider System:** Pre-built integrations for 33+ providers (OpenAI, Anthropic, Google, Groq, Vercel, TogetherAI, and more). See [Providers](/providers/overview).
...
The list above is a sample. The Swift AI SDK ships with 33 provider modules; see [Providers](/providers/overview) for the full list.
