  ...
  static func run() async throws {
    ...
    let customOpenAI = customProvider(
      languageModels: [
        ...
        "fast": openai.languageModel(modelId: "gpt-4o-mini"),
        "smart": openai.languageModel(modelId: "gpt-4o"),
    ...
    let limitedProvider = customProvider(
      languageModels: [
        "mini": openai.languageModel(modelId: "gpt-4o-mini"),
        "standard": openai.languageModel(modelId: "gpt-4o")
      ]
